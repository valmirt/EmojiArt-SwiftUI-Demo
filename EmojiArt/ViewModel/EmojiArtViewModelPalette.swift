//
//  EmojiArtViewModel+Palette.swift
//  EmojiArt
//
...
extension EmojiArtViewModel {
    private static let PalettesKey = "EmojiArtViewModel.PalettesKey"
    ...
    private(set) var paletteNames: [String:String] {
        get {
            UserDefaults.standard.object(forKey: EmojiArtViewModel.PalettesKey) as? [String:String] ?? [
                "😀😅😂😇🥰😉🙃😎🥳😡🤯🥶🤥😴🙄👿😷🤧🤡":"Faces",
                "🍏🍎🥒🍞🥨🥓🍔🍟🍕🍰🍿☕️":"Food",
                "🐶🐼🐵🙈🙉🙊🦆🐝🕷🐟🦓🐪🦒🦨":"Animals",
                "⚽️🏈⚾️🎾🏐🏓⛳️🥌⛷🚴‍♂️🎳🎼🎭🪂":"Activities"
        ...
        set {
            UserDefaults.standard.set(newValue, forKey: EmojiArtViewModel.PalettesKey)
